...
def make_data_loaders(train_df, val_df, test_df, image_dir, batch_size, image_size):
    ...
    train_dataset = ChestXRayDataset(df_dir=train_df, image_dir=image_dir, transform=train_transforms)
    val_dataset = ChestXRayDataset(df_dir=val_df, image_dir=image_dir, transform=val_transforms)
    test_dataset = ChestXRayDataset(df_dir=test_df, image_dir=image_dir, transform=val_transforms)
    ...
    return {'train': train_loader, 'val': val_loader, 'test': test_loader}, {'train': len(train_dataset), 'val': len(val_dataset), 'test': len(test_dataset)}
